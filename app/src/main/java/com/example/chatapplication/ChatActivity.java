...
import com.example.chatapplication.Chat.MediaAdapter;
import com.example.chatapplication.User.UserObject;
import com.example.chatapplication.Utils.SendNotification;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mSend = findViewById(R.id.send_bt);
        Button mAddMedia = findViewById(R.id.addMedia);
        mSend.setOnClickListener(new View.OnClickListener() {@Override public void onClick(View v) { sendMessage(); }});
        mAddMedia.setOnClickListener(new View.OnClickListener() {@Override public void onClick(View v) { openGallery(); }});
        ...
        mChatMessageDb.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                    if(dataSnapshot.exists())
                    {
                        ...
                        MessageObject showMessage = new MessageObject(dataSnapshot.getKey(), creatorID, text, mediaUrlList);
                        messageList.add(showMessage);
    ...
    {
         mMessage = findViewById(R.id.message_ed);
    ...
    private void openGallery() {
        ...
        startActivityForResult(intent.createChooser(intent, "Select Feature(s)"), PICK_IMAGE_INTENT);
